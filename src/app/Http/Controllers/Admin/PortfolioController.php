...
class PortfolioController extends Controller
{
    ...
    public $TITLE = ['Портфолио', 'портфолио'];
    public $MODEL = Portfolio::class;
    ...
    public function edit(Request $request , $id = null)
    {
        ...
        if ($request->isMethod('post')){
            ...
            $object->hide = empty($request->footer_hide) ?  0 : 1;
            ...
            FileUpload::uploadImage('image' , Content::class , 'image' , $object->id , 200 , 170 , '/images/portfolio' , false , $request);

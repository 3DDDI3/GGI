...
@section('content')
        ...
        <div class="admin_edit_block">
            ...
            <form  method="post" enctype="multipart/form-data" class="admin_edit-form">
                ...
                @include('admin.includes.input', ['label' => 'Должность', 'name' => 'name', 'value' => $object->name ?? '', 'required' => 'required'])
                ...
                <x-Admin.Accordion title="Английская версия">
                    @include('admin.includes.input', ['label' => 'Должность', 'name' => 'name_en', 'value' => $object->name_en ?? ''])

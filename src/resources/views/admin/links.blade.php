...
<x-Admin.NavBar title="Личный кабинет" url="pa" all="{{ isset($all) && $all }}">
    @include('admin.includes.menu.item', ['route' => 'admin.pa.index', 'name' => 'Пользователи'])
</x-Admin.NavBar>
...
@include('admin.includes.menu.item', [
    'route' => 'admin.eform.index',
    'name' => 'Электронная форма обращений',
])
@include('admin.includes.menu.item', [
...
@include('admin.includes.menu.item', [
    'route' => 'admin.institute-objects.index',
    'name' => 'Наши объекты',
])

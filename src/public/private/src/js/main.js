...
$(document).ready(function () {
    ...
    $(".add-new-work__button").on("click", function (e) {
        ...
        $($(newBlock).find("legend")[0]).html($($(newBlock).find("legend")[0]).html().replace(/Работы (\d{4}) года/, `Работы ${$("select[name='workYear']").val()} года`));
        $($(newBlock).find("legend")[0]).parents(".work").find("input[name='year']").val($("select[name='workYear']").val());
